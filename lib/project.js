...
BT.projectManager = SC.Object.create({
  ...
  extensions: function(){
    return Object.keys(this._fileClasses);
  }.property(),

  scriptExtensions: function(){
    var ret = [];
    Object.keys(this._fileClasses).forEach(function(ext){
      if(this._fileClasses[ext].isScript) ret.push(ext);
    });
    return ret;
  }.property(),
  ...
  stylesheetExtensions: function(){
    var ret = [];
    Object.keys(this._fileClasses).forEach(function(ext){
      if(this._fileClasses[ext].isStylesheet) ret.push(ext);
    });
    return ret;
  }.property(),
  ...
  resourceExtensions: function(){
    var ret = [];
    Object.keys(this._fileClasses).forEach(function(ext){
      if(this._fileClasses[ext].isResource) ret.push(ext);
    });
    return ret;
  }.property(),
});