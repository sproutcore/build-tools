          ...
          if(curFws.length === 0) return;
            ...
            curFws.forEach(function(fw){
              if(SC.typeOf(fw) === SC.T_STRING){
                ...
                // check whether config can be found
                // this is the difficult part, because parsing the fw config can cause another round of fw checking...
              }
