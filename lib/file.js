...
BT.File = SC.Object.extend({
  ...
  watchForChangesDidChange: function () {
    // We don't have to do individual file watchers, as the directory watchers also
    // can detect file changes, and that will save us quite a few of watchers...
    //
