...
BT.FrameworkScriptsController = SC.ArrayController.extend({
  ...
  dependenciesDidChange: function () {
    if (BT.runBenchmarks) SC.Benchmark.start('FrameworkScriptsController:dependenciesDidChange');
    ...
    if (BT.runBenchmarks) SC.Benchmark.end('FrameworkScriptsController:dependenciesDidChange');
