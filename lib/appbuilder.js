...
BT.AppBuilder = SC.Object.extend({
  ...
  */
  ...
  /**
    ...
    @property
    @type String
    @default '/static/%{frameworkName}/%{language}/%{frameworkContentHash}/%{relativePath}'
  */
  buildUrlTemplate: "/static/%{frameworkName}/%{language}/%{frameworkContentHash}/%{relativePath}",
