...
//
  ...
  _registerFrameworks: function () {
    ...
    var moduledeps = this._findModuleDeps(),
      modules = [];
    this._instantiateFrameworks(modules, moduledeps, { belongsTo: this, isModule: true });
    ...
    this._fwsFiles = this._fws.concat(this._bootstrap).concat(modules);
  },
