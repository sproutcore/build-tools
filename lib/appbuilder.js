...
//
  ...
  init: function () {
    ...
    if (fws && fws.indexOf('sproutcore') === -1 && !fws.findProperty('ref', 'sproutcore') && this.includeSC) {
  ...
  _instantiateFrameworks: function () {
    ...
    var fwdeps;
    this._fwdeps = fwdeps = this._findFrameworkDeps();
  ...
  wrapTest: function (testFile) {
    ...
    fw.dependencies.forEach(findDeps, this); // now all deps are in deps, doesn't need to be unique
    ...
    if (!fws.findProperty('ref', "sproutcore:debug")) fws.push(this._fws.findProperty("ref", "sproutcore:debug"));
    if (!fws.findProperty('ref', "sproutcore:testing")) fws.push(this._fws.findProperty('ref', "sproutcore:testing"));
